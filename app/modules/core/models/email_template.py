...
# Define the relationship in EmailTemplate
EmailTemplate.email_variables: List[EmailVariable] = Relationship(back_populates="email_templates", link_model=EmailTemplateEmailVariable)
